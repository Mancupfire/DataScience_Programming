...
source_notebook = os.path.join(script_dir, 'xgboost_new.ipynb')
output_notebook = os.path.join(script_dir, 'xgboost.ipynb')
...
for i, cell in enumerate(nb['cells']):
    ...
    # 5. Update model training (remove scaling references)
    elif 'XGBRegressor' in source_text and 'fit' in source_text:
        cell['source'] = [
...
print("\n" + "="*60)
print("XGBoost notebook successfully modified!")
print("="*60)
